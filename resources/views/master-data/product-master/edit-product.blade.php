            ...
            <div class="overflow-hidden bg-white shadow-smsm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="container mx-auto mt-5">
                        <h2 class="mb-5 text-2xl font-bold">Update
                        ...
                        <form action="{{ route('product-update', $product->id)}}" method="POST" class="p-6 bg-white rounded shadow-md">
                            ...
                            <div class="flex justify-end">
                                <button type="submit" class="px-4 py-2 text- Menampilkan data dari database kedalam tabel white bg-indigo-500 rounded hover:bg-indigo-600 focus:ring-2 focus:ring-indigo-500">Update Product</button>
                            </div>
                        </form>
                    </div>
                </div>
